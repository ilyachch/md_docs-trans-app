...
class App:
    ...
    def __init__(self):
        ...
        self.API_KEY = self.__set_api_key()
    ...
    def __process_args(self):
        self.parser.add_argument('-p', '--path', help='Path to folder to process.', dest='path', type=pathlib.Path)
        return self.parser.parse_args()

    def __set_api_key(self):
        if not os.path.exists('APIKEY'):
            raise ValueError('Not set APIKEY file with Yandex API key.')
